...
class CGAN():
    def __init__(self):
        self.img_shape = (config.IMAGE_SIZE, config.IMAGE_SIZE, config.IMAGE_CHANNEL)
        self.num_classes = config.NUM_OUTPUTS
        self.latent_dim = 100
    ...
    def build_generator(self):
        ...
        embed = Embedding(self.num_classes, self.latent_dim)(label)
