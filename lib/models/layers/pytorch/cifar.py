# coding=utf-8
from torch.nn import Module, Conv2d, BatchNorm2d, ReLU, Sequential,AdaptiveAvgPool2d, Linear, AvgPool2d, ZeroPad2d,\
    Sigmoid
...
class SENet(Module):
    def __init__(self, n_size = 3,  block = CifarSEBasicBlock, config=Cifar10Config(), num_classes=10, reduction=16):
